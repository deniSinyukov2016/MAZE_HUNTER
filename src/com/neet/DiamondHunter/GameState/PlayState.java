...
public class PlayState extends GameState {
	...
	public void init() {
		...
		tileMap.loadTiles("/Tilesets/new.gif");
	...
	private void populateDiamonds() {
		...
		d.setTilePosition(2,5);
		diamonds.add(d);

		d = new Diamond(tileMap);
		d.setTilePosition(19, 2);
		diamonds.add(d);
		...
		d = new Diamond(tileMap);
		d.setTilePosition(27, 2);
		diamonds.add(d);
		////d.addChange(new int[] {27, 7, 1});
		//d.addChange(new int[] {28, 7, 1});

		d = new Diamond(tileMap);
		d.setTilePosition(2, 15);
		diamonds.add(d);
		//d.addChange(new int[] { 31, 21, 1 });
		d = new Diamond(tileMap);
		d.setTilePosition(9, 16);
		diamonds.add(d);

		d = new Diamond(tileMap);
		d.setTilePosition(16, 15);
		diamonds.add(d);

		d = new Diamond(tileMap);
		d.setTilePosition(14, 27);
		diamonds.add(d);

		d = new Diamond(tileMap);
		d.setTilePosition(45, 4);
		diamonds.add(d);

		d = new Diamond(tileMap);
		d.setTilePosition(38, 12);
		diamonds.add(d);

		d = new Diamond(tileMap);
		d.setTilePosition(45, 17);
		diamonds.add(d);

		d = new Diamond(tileMap);
		d.setTilePosition(4, 22);
		diamonds.add(d);
		d = new Diamond(tileMap);
		d.setTilePosition(42, 26);
		diamonds.add(d);

		d = new Diamond(tileMap);
		d.setTilePosition(43,37);
		diamonds.add(d);

		d = new Diamond(tileMap);
		d.setTilePosition(38, 33);
		diamonds.add(d);

		d = new Diamond(tileMap);
		d.setTilePosition(42, 40);
		diamonds.add(d);

		d = new Diamond(tileMap);
		d.setTilePosition(46, 44);
		diamonds.add(d);

		d = new Diamond(tileMap);
		d.setTilePosition(12, 44);
		diamonds.add(d);

		d = new Diamond(tileMap);
		d.setTilePosition(2, 42);
		diamonds.add(d);
